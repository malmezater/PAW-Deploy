...
if ($vhdxtemp) {
    Write-Host "Linux Kali template is downloaded, proceeding with the script."
} else {
    Write-Host "Linux Kali template is not downloaded, please download the image file."
    exit
}
