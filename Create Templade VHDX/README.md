...
```powershell
Mount-VHD "C:\VMNAME\Virtual Hard Disks\DISKNAME.vhdx"
...
Dismount-VHD "C:\VMNAME\Virtual Hard Disks\DISKNAME.vhdx"
Optimize-VHD "C:\VMNAME\Virtual Hard Disks\DISKNAME.vhdx" -Mode Full
```
