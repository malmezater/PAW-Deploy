...
3. **[CONFIGURATION.md](CONFIGURATION.md)** — reference for every setting in `Settings.psm1`, `Apps.xml`, `Modules.xml`, packages, and `Config.xml`. New packages start from [Package-Template.xml](../templates/Package-Template.xml).
